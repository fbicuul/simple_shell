...
/**
 * free_env - To free the shell's environment
 * @env: Indicate shell's environment
 *
 * Return: void
 */
 ...
 * @vars: Indicate vars variable of struct vars_t
 * @str: Indicate name of env var to find.
