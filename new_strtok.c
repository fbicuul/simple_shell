...
/**
 * new_strtok - To custom strtok
 * @str: Indicate string to tokenize
 * @delim: Indicate delimiter to tokenize against
 *
...
/**
 * build_path - To combine two strings one representing the path directory and
 * another representing the command file.
 * @directory: Indicate a directory in the path.
 * @command: Indicate a file in a directory of the path.
