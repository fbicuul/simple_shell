...
/**
 * path_finder - To act as an interface for functions that will be able
 * to find the full path of a program.
 * @command: Indicate a common command such as ls, echo, pwd, etc..
 * Return: On success a string with the full path of the program.
 * @vars: Indicate structure with variables.
...
/**
 * find_env_index - To Find the index of an environmental variable.
 * @vars: Indicate structure with variables will be used
 * @str: Indicate environmental variable that needs to be found.
...
/**
 * tokenize_path - To separate a string of path as an array of
 * strings containing the path directories.
 * @vars: Indicate structure with variables will be used
 * @index: Indicate index of the path in the environment variables.
 * @str: Indicate string to separate and tokenize
...
/**
 * search_directories - To look through directories stored in path_tokens
 * for a specific file aka command.
 * @path_tokens: Indicate a pointer to array of strings containings de paths
 * contained in the PATH environment variable.
 * @command: Indicate a command. i.e. ls, /bin/ls, pwd, etc.
 *
