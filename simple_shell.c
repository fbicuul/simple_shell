 ...
 * @argc: Indicate number of arguments passed to main, unused
 * @argv: Indicate array of arguments passed to main
 * @environment: Indicate array of environment variables
 *
