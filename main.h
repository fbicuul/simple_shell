...
/**fixing**/
/**** Structure with the possible variables that we are going to use ****/
/**
 * struct variables - Indicate variables
 * @array_tokens: Indicate array of tokens(arguments)
  * @buffer: Indicate buffer of command
  * @status: to handle exit status
  * @argv: gets arguments at opening of shell
  * @counter: Indicate counts commands entered
  * @env: has enviroment
...
/**
 * struct builtins - To struct for the builtin functions
 * @name: Indicate name of builtin command
