...
/**
 * new_help_help - To help builtin command help
 * @vars: if command matches a builtin name, text file is sent to stdout
 * Return: 0 if sucess
 */
...
/**
 * new_help_exit - To help builtin command exit
 * @vars: if command matches a builtin name, text file is sent to stdout
 * Return: 0 if sucess
 */
...
/**
 * new_help_cd - To help builtin command cd
 * @vars: if command matches a builtin name, text file is sent to stdout
 * Return: 0 if sucess
 */
...
/**
 * new_help_env - To help builtin command env
 * @vars: if command matches a builtin name, text file is sent to stdout
 * Return: 0 if sucess
 */
