...
/**
 * tokenize - To tokenize a buffer with a delimiter just use for for_child
 * @line: Indicate buffer to tokenize
 * @delimiter: Indicate delimiter to tokenize along
 * @token_count: Indicate token count, size.
 * Return: pointer to an array of pointers to the tokens
 */
...
/**
 * token_interface - To token interface
 * @line: Indicate line get to be tokenized
 * @delimiter: Indicate any delimiter lie ; % " ", etc.
