...
/**
 * free_listint - To free pointers related with malloc
 * @head: Indicate the pointer of the list
 *
...
/**
 * new_history - To print the list of a single list
...
/**
 * _puts3 - To write a string to standard output
...
/**
 *print_message - To print a string to standart output
